...
NDefines.NNavy.COMBAT_LOW_ORG_HIT_CHANCE_PENALTY = -0.75	-- % of penalty applied to hit chance when ORG is very low.
NDefines.NNavy.COMBAT_LOW_MANPOWER_HIT_CHANCE_PENALTY = -0.5	-- % of penalty applied to hit chance when manpower is very low.
NDefines.NNavy.COMBAT_DAMAGE_RANDOMNESS = 0.5	-- random factor in damage. So if max damage is fe. 10, and randomness is 30%, then damage will be between 7-10.
...
NDefines.NNavy.BASE_CARRIER_SORTIE_EFFICIENCY = 1	-- factor of planes that can sortie by default from a carrier
...
NDefines.NNavy.AGGRESSION_HEAVY_GUN_EFFICIENCY_ON_LIGHT_SHIPS = 0.15-- ratio for scoring for different gun types against light ships
...
NDefines.NNavy.AGGRESSION_HEAVY_GUN_EFFICIENCY_ON_HEAVY_SHIPS = 1.1 -- ratio for scoring for different gun types against heavy ships
...
NDefines.NAir.NAVAL_STRIKE_DAMAGE_TO_STR = 0.7
NDefines.NAir.NAVAL_KAMIKAZE_DAMAGE_MULT = 5.0  -- vanilla is like 20
NDefines.NAir.NAVAL_STRIKE_DAMAGE_TO_ORG = 0.9
...
NDefines.NAir.NAVAL_STRIKE_CARRIER_MULTIPLIER = 7
